...
class StartupCheck extends ConsumerStatefulWidget {
  const StartupCheck({super.key});

  @override
  ConsumerState<StartupCheck> createState() => _StartupCheckState();
}

class _StartupCheckState extends ConsumerState<StartupCheck> {
  @override
