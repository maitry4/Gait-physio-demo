                        ...
                        children: [
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                              shape: BoxShape.circle,
                              border: Border.all(
                                color: (bothEnabled ? AppColors.success : AppColors.primary).withOpacity(0.2),
                                width: 2,
                              ),
                            ),
                          ),
                          ...
                          Stack(
                            ...
                            children: [
                              Icon(
                                ...
                                size: 68,
                                color: bothEnabled ? AppColors.success : AppColors.primary,
                              ),
                            ],
                          ),
                          ...
                          Positioned(
                            ...
                            child: Container(
                              ...
                              height: 36,
                              decoration: BoxDecoration(
                                color: (connState.isHotspotOn ? AppColors.success : AppColors.secondary).withOpacity(0.2),
                                shape: BoxShape.circle,
                              ),
                              child: Icon(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      _StatusPill(
                        ...
                        color: connState.isBluetoothOn ? AppColors.success : AppColors.primary,
                  ...
                  GestureDetector(
                    ...
                    child: AnimatedContainer(
                      ...
                      decoration: BoxDecoration(
                        color: bothEnabled ? AppColors.success : Colors.black.withOpacity(0.2),
