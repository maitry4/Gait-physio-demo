...
import 'screen1_connectivity.dart';
...
class _Screen0CredentialsState extends ConsumerState<Screen0Credentials> {
  ...
  void _submit() {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(builder: (_) => const Screen1Connectivity()),
    );
  }
                      ...
                      children: [
                        ...
                        TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            labelStyle: TextStyle(color: Colors.black.withOpacity(0.4)),
                            prefixIcon: const Icon(Icons.lock, color: Color(0xFFFF4E6A)),
                            filled: true,
                            fillColor: Colors.white,
                            enabledBorder: OutlineInputBorder(
                              borderRadius: BorderRadius.circular(16),
                        ...
                        if (_localError != null) ...[
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                              color: const Color(0xFFFF4E6A).withOpacity(0.1),
                              borderRadius: BorderRadius.circular(12),
                              border: Border.all(color: const Color(0xFFFF4E6A).withOpacity(0.3)),
                            ),
                            child: Row(
                              children: [
                                const Icon(Icons.error_outline, color: Color(0xFFFF4E6A), size: 20),
